...
public class InformationController {
    ...
    @PostMapping
    public ResponseEntity<?> insert(@RequestBody Information information) throws IOException {
        Information insert = informationService.insert(information);
        return ResponseEntity.ok(insert);
    }

    @PatchMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable int id, @RequestBody Information information) throws IOException {
